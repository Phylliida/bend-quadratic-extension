...
- `src/nat.bend` — the 123 Nat/Cmp laws (including the `Nat.divmod` and
...
transitive over imports: nat.bend 123, int.bend 29, qext.bend 31 = 29 Int + 2
QExt, rat.bend 172 = 123 Nat + 29 Int + 20 Rat.
