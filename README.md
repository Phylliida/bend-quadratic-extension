...
- `src/nat.bend` — the 121 Nat/Cmp laws (including the `Nat.divmod` and
...
transitive over imports: nat.bend 121, int.bend 28, qext.bend 30 = 28 Int + 2
QExt, rat.bend 167 = 121 Nat + 28 Int + 18 Rat.
